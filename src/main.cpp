...
#define SETUP_SMS_MESSAGE "SOLAR FLOOD ALARM IS INITIALIZED SUCCESSFULLY" // THIS IS THE SMS MESSAGE TO BE SENT BY THE PROTYPE TO THE RECEIVER NUMBER UPON STARTUP OR BOOTING

#define FLASH_SIZE 128
#define FLASH_MAGIC_ADDR 0
#define FLASH_MAGIC_VALUE 0x14826231
...
#define FLASH_DEFAULT_RECEIVER_NUMBER "+639671692901"
